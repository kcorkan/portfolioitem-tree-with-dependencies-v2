...
//         onTimeboxScopeChange: function(newTimebox) {
//             console.log('onTimeboxScopeChange',newTimebox)
//             this.callParent(arguments);
//             gApp.timeboxScope = newTimebox;
//             gApp.loadAppData();
//         },
//         onScopeChange: function(newTimebox) {
//             console.log('onScopeChange',newTimebox)
//             this.callParent(arguments);
//             gApp.timeboxScope = newTimebox;
//             gApp.loadAppData();
//         },
...
//             var model = null;
//             _.each(this.portfolioItemTypes, function(type) { 
//                 console.log('type',type.get('TypePath'))
//                 if (number == type.get('Ordinal')) { model = type; } 
//             });
//             return model && model.get('TypePath');
//         },
